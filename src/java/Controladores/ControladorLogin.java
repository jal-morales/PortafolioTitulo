...
public class ControladorLogin 
{
    ...
    //login a usuario
      public boolean Login(int  CodEmpresa, String usuario ,String pass)
  { boolean respuesta =false;
      try {
            ...
            //llamamos a la clase conect           
             ...
             String consulta  = "select * from LOGIN where CODEMPRESA="+CodEmpresa+" and USUARIO='"+usuario+"' and PASSWORD='"+pass+"';";   
